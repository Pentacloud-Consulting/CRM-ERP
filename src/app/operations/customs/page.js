  ...
  return (
    <div style={{ maxWidth: 1400, animation: 'fadeInUp var(--transition-slow) ease both' }}>
      ...
      <Modal
        ...
        title="New Customs Clearance"
        subtitle="File a customs declaration for a shipment"
        size="medium"
        footer={
          <>
            <Button variant="secondary" onClick={() => setShowNew(false)}>Cancel</Button>
            <Button onClick={handleCreate} disabled={!newClearance.shipment_id || !newClearance.jurisdiction}>Create Clearance</Button>
          </>
        }
      >
