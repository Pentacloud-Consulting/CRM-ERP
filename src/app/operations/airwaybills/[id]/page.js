...
export default function AWBDetailPage() {
  ...
  const isSent = awb.fwb_status === 'Sent' || awb.fwb_status === 'Acknowledged (FMA)';
  const isConfirmed = awb.fwb_status === 'Acknowledged (FMA)';
          ...
          <div className={styles.heroLeft}>
            ...
            <div>
              <div className={styles.heroTitleRow}>
                <h1 className={styles.heroTitle}>{formatAWBNumber(awb.awb_number)}</h1>
                <Badge variant={awb.awb_type === 'Master (MAWB)' ? 'primary' : 'neutral'}>{awb.awb_type}</Badge>
                <Badge variant={getFwbStatusVariant(awb.fwb_status)} dot>{awb.fwb_status}</Badge>
              </div>
          ...
          <div>
            ...
            <div className={styles.sectionCard}>
              ...
              <div className={styles.aviationRoute}>
                ...
                <div className={styles.airportNode}>
                  <div className={styles.airportCode}>{awb.destination_airport}</div>
            ...
            <div className={styles.aiInsightPanel}>
              ...
              <div className={styles.aiContent}>
                <ul style={{ paddingLeft: '20px', margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <li>Route {awb.origin_airport}-{awb.destination_airport} typically clears customs in 12 hours.</li>
