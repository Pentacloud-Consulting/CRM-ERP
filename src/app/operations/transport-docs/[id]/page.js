                    ...
                    <>
                      ...
                      <Button onClick={async () => {
                        try {
                          ...
                          if (element) {
                            const opt = { margin: [10, 10, 10, 10], filename: `invoice-${awb.doc_number}.pdf`, image: { type: 'jpeg', quality: 0.98 }, html2canvas: { scale: 2, useCORS: true }, jsPDF: { unit: 'mm', format: 'a4', orientation: 'portrait' } };
          ...
          <div>
            ...
            <div className={styles.sectionCard}>
              ...
              <div className={styles.actionList}>
                ...
                {(awb.doc_type === 'Master (MAWB)' || awb.doc_type === 'MAWB') && (
                  <div className={styles.actionItem}>
